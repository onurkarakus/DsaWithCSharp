...
namespace ArraysCode.JaggedArray.YearlyTransportPlan;

public static class YearlyTransportPlanArray
{
    public static void RunSample()
    {
        Random random = new();

        int transportTypeCount = Enum.GetNames(typeof(TransportEnum)).Length;
        ...
        for (int month = 1; month <= 12; month++)
        {
            ...
            {
                int randomType = random.Next(transportTypeCount);
